...
public class GenomePrinter {
	...
	protected String STYLESHEET = "edge {" + "text-background-mode: rounded-box;" + "text-background-color: black;"
			+ "text-alignment: center;" + "text-color: white;" + "arrow-size:5;" + "text-size: 10;" + "}" +

			"edge.inactive {" + "fill-color:gray;" + "}" +

			"node {" + "fill-color: black;" + "text-background-mode: rounded-box;" + "text-background-color: black;"
			+ "text-alignment: center;" + "text-color: white;" + "size: 30;" + "text-size: 10;" + "}" +

			"node.i {" + "fill-color: red;" + "}" +

			"node.h {" + "fill-color: green;" + "}" +

			"node.o {" + "fill-color: blue;" + "}";
